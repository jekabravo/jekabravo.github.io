  ...
  const translations = {
    en: {
      ...
      about: {
        ...
        bio_p1: "Welcome. I am Jessica Bravo, a Licensed Clinical Social Worker (NC License #C017999) providing dedicated, trauma-informed teletherapy across all of North Carolina. My practice is built on creating a secure, culturally affirming sanctuary where you can explore your thoughts without judgment.",
        bio_p2: "As a bilingual clinician (English & Spanish), I specialize in helping individuals and couples untangle generational patterns, heal attachment wounds, and navigate monumental life transitions. My therapeutic work thoughtfully blends Internal Family Systems (IFS), Somatic Experiencing, and Relational Psychodynamics to facilitate lasting, rooted transformation.",
        license_badge_title: "North Carolina Licensed Clinical Social Worker",
        license_badge_sub: "LCSW #C017999 | Verified Telehealth Provider",
        val1_title: "Grounded Healing",
        val1_desc: "Root Chakra and somatic body awareness to restore emotional safety and nervous system regulation.",
        val2_title: "Transformational Care",
        val2_desc: "Internal Family Systems (IFS) to harmonize inner parts, release trauma, and step into Self-leadership.",
    ...
    es: {
      ...
      about: {
        ...
        bio_p1: "Bienvenido/a. Soy Jessica Bravo, Trabajadora Social Clínica Licenciada (Licencia NC #C017999) dedicada a ofrecer teleterapia informada en trauma en todo el estado de Carolina del Norte. Mi práctica se fundamenta en crear un santuario seguro y culturalmente afirmativo donde puedas expresarte sin juicios.",
        bio_p2: "Como terapeuta bilingüe (inglés y español), me especializo en ayudar a adultos y parejas a desenredar patrones generacionales, sanar heridas de apego y transitar cambios de vida significativos. Integro Sistemas de la Familia Interna (IFS), Experiencia Somática y Psicodinámica Relacional para facilitar una transformación profunda y arraigada.",
        license_badge_title: "Trabajadora Social Clínica Licenciada de NC",
        license_badge_sub: "LCSW #C017999 | Proveedora Verificada de Teleterapia",
        val1_title: "Sanación Arraigada",
        val1_desc: "Conexión con el Chakra Raíz y conciencia corporal somática para restaurar la seguridad y regular el sistema nervioso.",
